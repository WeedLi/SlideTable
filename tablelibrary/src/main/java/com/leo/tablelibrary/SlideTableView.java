...
import com.leo.tablelibrary.adapter.ContentAdapter;
import com.leo.tablelibrary.adapter.ITableAdapter;
import com.leo.tablelibrary.adapter.LinearLayoutViewHolder;
import com.leo.tablelibrary.adapter.TableFirstColAdapter;
import com.leo.tablelibrary.adapter.TableFirstRowAdapter;
    ...
    public boolean onInterceptTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (yDiff > mTouchSlop || xDiff > mTouchSlop || !mScroller.isFinished()) {
                    return true;
                }
                break;
        }
